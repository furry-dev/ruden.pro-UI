...
import Ecosystem from "@/components/screens/Account/Ecosystem/Ecosystem"

/**
 * Home page component.
 * @returns {ReactElement} The home component ReactElement.
 */
export default function Account(): ReactElement {
    const [ecosystemIsOpened, setEcosystemIsOpened] = useState(false)

    return (
        <>
            <Ecosystem isOpened={ecosystemIsOpened} setIsOpened={setEcosystemIsOpened}/>
            <Image className={styles.userBackgroundImage} src={"/manga-cover.jpg"} alt={"account background"}
                width={500} height={200}></Image>
            <main className={styles.main}>
                <section className={styles.userData}>
                    <div className={styles.userActions}>
                        <Link href={"/settings"} className={styles.actionsButton}><FontAwesomeIcon
                ...
                <section className={styles.section}>
                    ...
                    <ul className={styles.list}>
                        <li>
                            <button className={styles.listLink} onClick={() => setEcosystemIsOpened(true)}>
                        ...
                        <li><Link className={styles.listLink} href={"/contacts"}>
